 ...
 * established for {@link InvalidRequestException} (400s), now shared across the 404 paths ({@link
 * ProofNotAvailableException}, {@code LeafNotFoundException}) as well.
 *
 ...
 *
 * <p>The marker lives in the {@code log} layer (the lower layer that {@code web} already depends
 * on) so both the service-thrown exceptions here and the controller-thrown {@code
 * LeafNotFoundException} in {@code web} can carry it without inverting the package layering.
 */
